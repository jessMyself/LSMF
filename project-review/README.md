...
This directory contains the consolidated engineering records retained for the
public release snapshot. Internal AI task prompts, working handoffs, local
machine paths, and operator-specific transition notes are intentionally
excluded.

## Current records

- [Architecture and trust boundaries](architecture.md)
- [Security and readiness audit](audit-report.md)
- [Qt-only release roadmap](consolidated-qt-roadmap.md)
- [Current claim matrix](SECTION4_CLAIM_MATRIX.md)
- [Section 1 VM evidence](SECTION1_VM_EVIDENCE_2026-08-07.md)
